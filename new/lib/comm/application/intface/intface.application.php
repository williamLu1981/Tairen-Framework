...
abstract class iApplication {
    ...
    public function __construct() {
        ...
        if (!class_exists('core')) {
            ...
            require_once('comm/core/Core.php');
        }
    }
    ...
    public function initialize() {
        ...
        $this->params = $this->loadModule('www/'.$this->config->paramsFix . '/Params.php', 'params', 'urlparse');
        ...
        $fileName = sprintf('/act.%s.php', $this->request->getAction());
        $className = sprintf('act_%s', $this->request->getAction());

        $this->action = $this->loadModule('www/'.$this->config->actionFix . $fileName, $className, 'action');
     ...
     *
     */
    public abstract function runLast();
    ...
    public function dispatch() {
        ...
        $this->runLast();  //application的runLast
